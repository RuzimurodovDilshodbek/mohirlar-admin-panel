...
const routes = [
  { path: '/login', name: 'login', component: () => import('@/pages/LoginPage.vue'), meta: { guest: true } },
  {
    ...
    children: [
      ...
      { path: 'companies', name: 'companies', component: () => import('@/pages/CompaniesPage.vue'), meta: { title: 'Kompaniyalar' } },
      ...
      { path: 'commerce', name: 'commerce', component: () => import('@/pages/CommercePage.vue'), meta: { title: 'Moliya va obunalar' } },
      { path: 'content', name: 'content', component: () => import('@/pages/ContentPage.vue'), meta: { title: 'Kontent va maʼlumotnomalar' } },
